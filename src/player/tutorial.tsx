...
export function Tutorial(props: { url?: string, user: User | null }) {
    ...
    return <div>
        <Overlay portalClassName="portal-center" className="overlay-center" isOpen={open} onClose={onClose}>
        ...
        {showVideo ? <YoutubeModal url={url} onClose={() => setShowVideo(false)} /> : null}
    </div>;
}